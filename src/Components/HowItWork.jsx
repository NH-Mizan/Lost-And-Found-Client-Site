            ...
            <section class="bg-white py-8">
                ...
                <div className="text-center py-12 ">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <img src="https://i.ibb.co.com/nQ0XZNM/images-1.jpg" alt="Step 3" class="mx-auto w-28 h-28 rounded-full mb-4" />
                        ...
                        <img src="https://i.ibb.co.com/k6bj6qq/img3.jpg" alt="Step 3" class="mx-auto w-28 h-28 rounded-full mb-4" />
                        ...
                        <div class="text-center border-2 bg-lime-200 border-red-300 rounded-xl p-4">
                            <img src="https://i.ibb.co.com/yhHmXJp/images-4.jpg" alt="Step 3" class="mx-auto w-28 h-28 rounded-full mb-4" />
